  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${blackRockDesertBackground})`,
        }}
        aria-hidden="true"
      />
      ...
      <div className="container relative">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-4 leading-relaxed text-muted-foreground">
            ISOC Nevada is volunteer-driven and 100% funded by community
            contributions. Every dollar stays in-state, supporting workshops,
            broadband mapping, and policy advocacy.
          </p>
        </div>

        <div className="mt-12 grid gap-6 lg:grid-cols-[1.3fr_1fr]">
          {/* Online donation */}
          <div className="overflow-hidden rounded-2xl border border-border/80 bg-card/90 p-2 shadow-elegant backdrop-blur-sm">
            {/* Donation header */}
            <div className="rounded-xl bg-gradient-primary p-8 text-primary-foreground">
              ...
              <p className="mt-2 max-w-md text-sm text-white/80">
                Zeffy passes 100% of your donation to the chapter, with no
            ...
            <div className="mt-2 overflow-hidden rounded-xl bg-background">
              <iframe
                ...
                src="https://www.zeffy.com/embed/donation-form/chapter-formation-donation"
            ...
            <div className="p-4">
              ...
              >
                <a
                  href="https://www.zeffy.com/en-US/donation-form/chapter-formation-donation"
                  target="_blank"
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-border/80 bg-card/90 p-7 shadow-card backdrop-blur-sm">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                Annual sponsorship packages for Nevada businesses, ISPs, and
                institutions supporting the open Internet. Tiered benefits
                available.
              </p>
